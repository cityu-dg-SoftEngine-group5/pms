<template>
  <div
      v-loading="loading"
      element-loading-text="正在检测扫码设备是否接入"
...
<!--      </el-select>-->
      ...
      <el-button type="primary" style="margin-left: 5px;" @click="loadPost">扫码入库</el-button>
      <el-button type="success" @click="resetParam">扫码出库</el-button>
    ...
    >
      ...
      <el-table-column prop="storage" label="药柜" width="180" :formatter="formatStorage">
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item label="药柜" prop="storage">
          <el-col :span="20">
            <el-select v-model="form.storage" placeholder="请选择药柜" style="margin-left: 5px;">
              <el-option
                  v-for="item in storageData"
                  :key="item.id"
                  :label="item.name"
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        storage:[
          {required: true, message: '请选择药柜', trigger: 'blur'}
        ],
        goodstype:[
