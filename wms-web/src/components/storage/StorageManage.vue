<template>
    <div>
        <div style="margin-bottom: 5px;">
            <el-input v-model="name" placeholder="请输入药柜名" suffix-icon="el-icon-search" style="width: 200px;"
...
<!--            </el-table-column>-->
          <el-table-column label="ID" width="60">
            ...
            <el-table-column prop="name" label="药柜名" width="180">
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                <el-form-item label="药柜名" prop="name">
                    <el-col :span="20">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    name: [
                        {required: true, message: '请输入药柜名', trigger: 'blur'}
                    ]
                }
            }
        },
